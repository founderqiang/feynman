...
export type LivePackageToolSpec = {
	name: string;
};

export type LivePackageToolGroup = {
	title: string;
	tools: LivePackageToolSpec[];
};
...
export declare const livePackageToolGroups: LivePackageToolGroup[];
